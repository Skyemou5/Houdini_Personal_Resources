...
class Ui_RSMatBuilder(object):
    def setupUi(self, RSMatBuilder):
        ...
        self.cbx_triplanar = QtWidgets.QCheckBox(RSMatBuilder)
        self.cbx_triplanar.setObjectName("cbx_triplanar")
        self.verticalLayout.addWidget(self.cbx_triplanar)
    ...
    def retranslateUi(self, RSMatBuilder):
        ...
        self.cbx_triplanar.setText(_translate("RSMatBuilder", "Insert Triplanar"))
...
if __name__ == "__main__":
    ...
    RSMatBuilder = QtWidgets.QWidget()
    ui = Ui_RSMatBuilder()
    ui.setupUi(RSMatBuilder)
    RSMatBuilder.show()
    sys.exit(app.exec_())
